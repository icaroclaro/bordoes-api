package com.bordoes.dominio.entidade;
...
public class Artista {
    ...
    public Artista(int id, String nome, String detalhe, String instagram, String urlFotoHome, String urlFotoDetalhe, boolean habilitado) {
        this.id =id;
        this.nome = nome;
